...
<head>
    ...
    <style>
        ...
        * {
        ...
        .hero::before {
            ...
            background:
                linear-gradient(135deg,
                    rgba(10, 36, 99, 0.85),
                    rgba(27, 79, 216, 0.6)),
                url('https://i.ytimg.com/vi/MEmt8iI9vA4/maxresdefault.jpg') center/cover no-repeat;
            z-index: 0;
        }
        ...
        .hero::after {
            ...
            width: 600px;
            height: 600px;
            background: radial-gradient(circle, rgba(27, 79, 216, 0.35), transparent);
            border-radius: 50%;
            z-index: 1;
        }
  ...
  font-weight: 700;
        ...
        .keunggulan-card:hover .kard-icon {
            background: var(--blue-mid);
        }
...
========================= */
        ...
        .register-card:hover .card-icon svg {
            stroke: white;
        }
        ...
        .register-card:hover .card-arrow svg {
...
<body>
    ...
    <nav id="navbar">
        <a class="nav-logo" href="#">
            ...
            <div>
                <span>SMK MAHAPUTRA CERDAS UTAMA</span>
    ...
    <section class="hero">
        <div class="hero-grid">
            <div>
                ...
                <p>SMA Nusantara Unggul hadir sebagai institusi pendidikan yang menjunjung keunggulan akademik, karakter
                    mulia, dan kesiapan menghadapi tantangan global.</p>
                <div class="hero-btns">
                    <a class="btn-primary" href="#regis">Daftar Sekarang</a>
    ...
    <section id="register">
        <div class="section-inner">
            ...
            <h2 class="section-title">Bergabung Bersama<br>Kami</h2>
            <p class="section-subtitle">Pilih jalur pendaftaran sesuai dengan peran Anda. Proses mudah, cepat, dan
                seluruhnya dapat dilakukan secara online.</p>

            <div class="register-grid">
                <!-- Siswa -->
                <a href="/ppdb/register" class="register-card">
                    <div class="card-icon">
                    ...
                    <div>
                        <div class="card-tag">Peserta Didik Baru</div>
                        <div class="card-title">Daftar sebagai Calon Siswa</div>
                    </div>
                    <p class="card-desc">Ikuti proses Penerimaan Peserta Didik Baru (PPDB) secara online. Lengkapi data
                        diri, unggah dokumen, dan pantau status pendaftaran Anda.</p>
                ...
                <!-- Guru -->
                <a href="/recruitment/guru" class="register-card">
                    <div class="card-icon">
                        <svg viewBox="0 0 24 24">
                    ...
                    <div>
                        <div class="card-tag">Tenaga Pengajar</div>
                        <div class="card-title">Lamar sebagai Calon Guru</div>
                    </div>
                    <p class="card-desc">Bergabunglah dengan tim pengajar profesional kami. Kirimkan lamaran dan dokumen
                        kompetensi Anda untuk diproses lebih lanjut.</p>
                    <div class="card-arrow">
                        Kirim Lamaran
                        <svg viewBox="0 0 24 24">
                            <path d="M5 12h14M12 5l7 7-7 7" />
                ...
                <!-- Pegawai -->
                <a href="/recruitment/pegawai" class="register-card">
                    <div class="card-icon">
                        <svg viewBox="0 0 24 24">
                    ...
                    <div>
                        <div class="card-tag">Tenaga Kependidikan</div>
                        <div class="card-title">Lamar sebagai Pegawai</div>
                    </div>
                    <p class="card-desc">Kami membuka kesempatan bagi tenaga administrasi, staf tata usaha, dan posisi
                        kependidikan lainnya untuk bergabung dalam tim kami.</p>
                    <div class="card-arrow">
                        Lihat Lowongan
                        <svg viewBox="0 0 24 24">
                            <path d="M5 12h14M12 5l7 7-7 7" />
    ...
    <section class="profil" id="profil">
        <div style="max-width:1200px;margin:0 auto;">
            ...
            <p class="section-sub">Lebih dari tiga dekade mendidik generasi penerus bangsa dengan standar akademik
                tinggi dan nilai-nilai luhur.</p>
        </div>
        <div class="profil-grid reveal">
            ...
            <div>
                <p style="font-size:15px;color:var(--gray-text);line-height:1.8;margin-bottom:28px;">
                    SMA Nusantara Unggul berdiri pada tahun 1990 di Kota Bandung, Jawa Barat. Selama lebih dari 30
                    tahun, kami berkomitmen menghadirkan pendidikan berkualitas yang memadukan penguasaan ilmu
                    pengetahuan, pembentukan karakter, dan pengembangan bakat siswa secara menyeluruh.
                </p>
    ...
    <section id="keunggulan" style="background:var(--white);padding:90px 6%;">
        <div style="max-width:1200px;margin:0 auto;" class="center">
            ...
            <p class="section-sub">Kami hadir dengan berbagai keistimewaan yang dirancang untuk mendukung tumbuh
                kembang siswa secara optimal.</p>
        </div>
        <div class="keunggulan-grid">
            <div class="keunggulan-card reveal">
                <div class="kard-icon">📚</div>
                <h3>Kurikulum Terpadu</h3>
                <p>Menggabungkan Kurikulum Merdeka dengan program pengayaan akademik internasional, menyiapkan siswa
                    untuk kompetisi nasional dan global.</p>
            </div>
            <div class="keunggulan-card reveal">
                <div class="kard-icon">👩‍🏫</div>
                <h3>Guru Berpengalaman</h3>
                <p>85+ tenaga pendidik berpendidikan S2 dan S3, bersertifikat, dan berpengalaman lebih dari 10 tahun di
                    bidangnya.</p>
            </div>
            <div class="keunggulan-card reveal">
                <div class="kard-icon">🔬</div>
                <h3>Laboratorium Modern</h3>
                <p>Fasilitas lab Fisika, Kimia, Biologi, dan Komputer dengan peralatan terkini yang mendukung
                    pembelajaran berbasis riset.</p>
            </div>
            <div class="keunggulan-card reveal">
                <div class="kard-icon">🌐</div>
                <h3>Program Internasional</h3>
                <p>Kerjasama dengan sekolah mitra di Jepang, Australia, dan Malaysia untuk program pertukaran pelajar
                    dan joint-study.</p>
            </div>
            <div class="keunggulan-card reveal">
                <div class="kard-icon">🏆</div>
            ...
            <div class="keunggulan-card reveal">
                ...
                <p>Program mentoring, pesantren kilat, dan kegiatan sosial yang membentuk siswa berjiwa pemimpin dan
                    berempati tinggi.</p>
            </div>
        </div>
    </section>
    ...
    <section class="program" id="program">
        <div style="max-width:1200px;margin:0 auto;" class="center">
            ...
            <p class="section-sub">Tiga jalur program dirancang untuk memenuhi kebutuhan dan potensi unik setiap siswa.
            </p>
        </div>
        <div class="program-grid">
            <div class="program-card reveal">
                ...
                <h3>Program MIPA</h3>
                <p>Fokus pada ilmu Matematika, Fisika, Kimia, dan Biologi dengan pendekatan eksperimen dan pemecahan
                    masalah kompleks.</p>
            ...
            <div class="program-card reveal">
                ...
                <h3>Program IPS</h3>
                <p>Mengembangkan pemahaman mendalam tentang Ekonomi, Sejarah, Geografi, dan Sosiologi untuk calon
            ...
            <div class="program-card reveal">
                ...
                <p>Mendalami Bahasa Inggris, Bahasa Jepang, dan Bahasa Arab dengan pendekatan komunikatif dan budaya
                    global.</p>
                <ul class="program-features">
    ...
    <section id="fasilitas" style="background:var(--gray-soft);padding:90px 6%;">
        <div style="max-width:1200px;margin:0 auto;" class="center">
            ...
            <p class="section-sub">Lingkungan belajar yang nyaman dan modern untuk menunjang setiap aspek perkembangan
                siswa.</p>
        </div>
    ...
    <section class="testimoni" id="testimoni">
        ...
        <div class="testi-grid">
            <div class="testi-card reveal">
                <div class="stars">★★★★★</div>
                <p>Guru-gurunya sangat kompeten dan sabar. Anak saya yang awalnya takut matematika, sekarang justru jadi
                    juara olimpiade. Luar biasa!</p>
            ...
            <div class="testi-card reveal">
                <div class="stars">★★★★★</div>
                <p>Tiga tahun di SMA Nusantara Unggul mengubah saya. Sekarang saya kuliah di ITB dengan beasiswa penuh.
                    Terima kasih untuk semua pembinaan yang diberikan.</p>
                <div class="testi-author">
            ...
            <div class="testi-card reveal">
                <div class="stars">★★★★★</div>
                <p>Fasilitas lengkap, guru ramah, dan lingkungan sekolah sangat kondusif. Pilihan terbaik untuk
                    putra-putri Anda menggapai masa depan cerah.</p>
                <div class="testi-author">
    ...
    <section class="pendaftaran" id="pendaftaran">
        ...
        <p class="section-sub">Jangan lewatkan kesempatan emas bergabung dengan keluarga besar SMA Nusantara Unggul.
            Kuota terbatas!</p>
        ...
        <div class="pendaftaran-form">
            ...
            <button class="btn-daftar" onclick="alert('Terima kasih! Tim kami akan menghubungi Anda segera.')">Kirim
                Minat →</button>
        </div>
        <p style="color:rgba(255,255,255,0.4);font-size:12px;margin-top:16px;">
            Atau hubungi kami via WhatsApp: <a href="https://wa.me/6281234567890"
                style="color:rgba(255,255,255,0.7);">+62 812-3456-7890</a>
        </p>
    </section>
    ...
    <section class="kontak" id="kontak">
        <div style="max-width:1200px;margin:0 auto;">
            ...
            <p class="section-sub">Kami siap menjawab setiap pertanyaan Anda tentang sekolah dan proses pendaftaran.
            </p>
        </div>
            ...
            <div>
                <div class="kontak-item reveal">
                    ...
                    <div>
                        ...
                        <span>Jl. Pendidikan Raya No. 88, Kelurahan Sukasari,<br>Kecamatan Coblong, Kota Bandung 40133,
                            Jawa Barat</span>
                    </div>
                </div>
                <div class="kontak-item reveal">
    ...
    <footer>
        <div class="footer-grid">
            <div class="footer-brand">
                ...
                <p>Mendidik generasi penerus bangsa dengan keunggulan akademik, karakter mulia, dan wawasan global sejak
                    1990.</p>
            </div>

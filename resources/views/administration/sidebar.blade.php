            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/administration/major" aria-expanded="false">
                        ...
                        <span class="hide-sitemap">Jurusan</span>
                    </a>
                </li>

                <li class="sidebar-item">
                    <a class="sidebar-link" href="/administration/classes" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/administration/student/" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/administration/student/10" aria-expanded="false">
                        <span>
                            <i class="ti ti-user"></i>
                        </span>
                        <span class="hide-menu">Siwa Kelas X</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/administration/student/11" aria-expanded="false">
                        <span>
                            <i class="ti ti-user"></i>
                        </span>
                        <span class="hide-menu">Siswa Kelas XI</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/administration/student/12" aria-expanded="false">
                        <span>
                            <i class="ti ti-user"></i>
                        </span>
                        <span class="hide-menu">Siswa Kelas XII</span>
                    </a>
                </li>

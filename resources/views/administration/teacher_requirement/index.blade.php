        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Persyaratan Guru</h4>
        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-5 position-relative">
                    <h4 class="card-title mb-0">Daftar Persyaratan Guru</h4>
                    <a href="/administration/teacher-requirement/create" class="btn btn-primary position-absolute top-0 end-0">Tambah Persyaratan</a>
                </div>
                ...
                <div class="table-responsive">
                    <table id="file_export" class="table w-100 table-striped table-bordered display text-nowrap">
                        ...
                        <tbody>
                            <!-- start row -->
                            @foreach ($teach_req as $no => $requirements)
                                <tr>

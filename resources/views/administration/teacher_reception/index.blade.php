                          ...
                          @foreach ( $teacher as $no=> $teach)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('administration.teacherReception.accept', $teach->usr_id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button class="btn btn-success btn-sm">Terima</button>
                                    </form>
                                    <a href="/administration/teacher-reception/{{ $teach->usr_id}}/reject" class="btn btn-danger btn-sm" onclick="confirmDelete('{{ $teach->usr_name }}')">Tolak</a>
                                </td> 
                            </tr>
                            @endforeach<!-- end row -->
...
@push('script')
    ...
    let text = `Apakah Anda yakin ingin menolak kandidat ${nama}?`;

                ...
                <form action="" method="post">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select mr-sm-2"  name="ppd_academic_id"
                                    ...
                                    @foreach ($academic as $acy)
                                        <option value="{{ $acy->acy_id }}"
                                            {{ $edit_ppdb->ppd_academic_id == $acy->acy_id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="ppd_start_date" value="{{$edit_ppdb->ppd_start_date}}" class="form-control" id="exampleInputText2"
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="ppd_end_date" value="{{$edit_ppdb->ppd_end_date}}" class="form-control" id="exampleInputText2"
                                    placeholder="" required oninvalid="this.setCustomValidity('Singkatan Wajib Diisi')"
                                    onchange="this.setCustomValidity('')">
                            </div>
                            @error('mjr_prefix')
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="ppd_entry_fee" value="Rp {{ number_format($edit_ppdb->ppd_entry_fee,0,',','.') }}" class="form-control" id="ppd_entry_fee"
                                    placeholder="" required oninvalid="this.setCustomValidity('Singkatan Wajib Diisi')"
                                    onchange="this.setCustomValidity('')">
                            </div>
                            @error('mjr_prefix')

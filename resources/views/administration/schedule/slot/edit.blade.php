    ...
    <div class="datatables">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('administration.schedule.slot.update', $scheduleSlot->slt_id) }}"
                      method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="slt_day"
                                ...
                                <option value="1"
                                    {{ old('slt_day', $scheduleSlot->slt_day) == 1 ? 'selected' : '' }}>
                                    Senin
                                </option>

                                <option value="2"
                                    {{ old('slt_day', $scheduleSlot->slt_day) == 2 ? 'selected' : '' }}>
                                    Selasa
                                </option>

                                <option value="3"
                                    {{ old('slt_day', $scheduleSlot->slt_day) == 3 ? 'selected' : '' }}>
                                    Rabu
                                </option>

                                <option value="4"
                                    {{ old('slt_day', $scheduleSlot->slt_day) == 4 ? 'selected' : '' }}>
                                    Kamis
                                </option>

                                <option value="5"
                                    {{ old('slt_day', $scheduleSlot->slt_day) == 5 ? 'selected' : '' }}>
                                    Jumat
                                </option>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="slt_type"
                                ...
                                <option value="lesson"
                                    {{ old('slt_type', $scheduleSlot->slt_type) === 'lesson' ? 'selected' : '' }}>
                                    Pelajaran
                                </option>

                                <option value="break"
                                    {{ old('slt_type', $scheduleSlot->slt_type) === 'break' ? 'selected' : '' }}>
                                    Istirahat
                                </option>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="number"
                                   ...
                                   class="form-control"
                                   min="1"
                                   value="{{ old('slt_number', $scheduleSlot->slt_number) }}"
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="time"
                                   ...
                                   id="slt_start_time"
                                   class="form-control"
                                   value="{{ old('slt_start_time', \Carbon\Carbon::parse($scheduleSlot->slt_start_time)->format('H:i')) }}"
                                   required>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="time"
                                   ...
                                   id="slt_end_time"
                                   class="form-control"
                                   value="{{ old('slt_end_time', \Carbon\Carbon::parse($scheduleSlot->slt_end_time)->format('H:i')) }}"
                                   required>

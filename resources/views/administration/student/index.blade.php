        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-5 position-relative">
                    ...
                    <a href="/administration/students/create"
                        ...
                        <tbody>
                            ...
                            @foreach ($student as $no => $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $item->student?->classes?->cls_level ?? '-' }} {{$item->student?->classes?->cls_major?->mjr_abbr ??''}} {{$item->student?->classes?->cls_number ??''}}
                                    </td>

                                    <td>
                                        <a href="/administration/students/{{ $item->usr_id }}/show"

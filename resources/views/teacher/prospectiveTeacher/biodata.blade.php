                                                ...
                                                <div id="step-4" class="content">
                                                    <form>
                                                        ...
                                                        <div class="form-group mb-2">
                                                            ...
                                                            <input type="text" class="form-control" id="nametext" aria-describedby="nama" placeholder="Nama Sekolah">
                                                        </div>
                                                        <div class="form-group mb-2">
                                                            <label class="form-">Kelas</label>
                                                            <input type="number" class="form-control" id="nametext" aria-describedby="nama" placeholder="Kelas">
                                                        </div>
                                                        <div class="form-group mb-2">
                                                            <label class="form-">Jumlah Jam</label>
                                                            <input type="number" class="form-control" id="nametext" aria-describedby="nama" placeholder="Jumlah Jam">
                                                        </div>
                                                        <div class="form-group mb-2">
                                                            <label class="form-">Tahun</label>
                                                            <input type="number" class="form-control" id="nametext" aria-describedby="nama" placeholder="Tahun">
                                                        </div>
                                                        <div class="form-group mb-2">

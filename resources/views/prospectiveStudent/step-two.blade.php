...
<script>
    function stepTwo() {
        ...
        let formData = {
            ...
            adr_province_value: $('#province option:selected').text(),
            adr_regency: $('#regency').val(),
            adr_regency_value: $('#regency option:selected').text(),
            adr_district: $('#district').val(),
            adr_district_value: $('#district option:selected').text(),
            adr_village: $('#village').val(),
            adr_village_value: $('#village option:selected').text(),
